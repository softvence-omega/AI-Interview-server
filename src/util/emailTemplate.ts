export const generateEmailTemplate = ({
    title,
    message,
    footer = "Thank you for being a valuable part of the AI Interview community. We’re here to support your growth every step of the way.",
    ...
    return `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background-color: #f4f4f4; padding: 40px 20px;">
        ...
        <p style="text-align: center; font-size: 12px; color: #999; margin-top: 20px;">
          This is an automated message from <strong>AI Interview</strong>. Please do not reply directly to this email.<br />
