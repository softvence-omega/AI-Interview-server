...
MockInterviewRoutes.post('/create_question_bank',auth([userRole.admin]), Mock_interviewsController.create_question_bank);
MockInterviewRoutes.post('/update_question_bank',auth([userRole.admin]), Mock_interviewsController.update_question_bank);
